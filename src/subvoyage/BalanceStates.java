...
public class BalanceStates {
    ...
    HELIO_T2_DPS = OFFENSE_DMG_U * 3.2f,

    HYDRO_T2_HU = DEFENSE_HP_U * 3f,
    HYDRO_T2_DPS = DEFENSE_DMG_U * 3f,

    ROVER_T2_HU = SPECIAL_HP_U * 2.5f,
    ROVER_T2_DPS = SPECIAL_DMG_U * 4.8f,

    //UNITS TIER3
    HELIO_T3_HU = OFFENSE_HP_U * 4.5f,
    HELIO_T3_DPS = OFFENSE_DMG_U * 8.2f,

    HYDRO_T3_HU = DEFENSE_HP_U * 6f,
    HYDRO_T3_DPS = DEFENSE_DMG_U * 8.5f,

    ROVER_T3_HU = SPECIAL_HP_U * 4.25f,
    ROVER_T3_DPS = SPECIAL_DMG_U * 8.3f,

    //UNITS TIER4
    HELIO_T4_HU = OFFENSE_HP_U * 16,
    HELIO_T4_DPS = OFFENSE_DMG_U * 18.2f,

    HYDRO_T4_HU = DEFENSE_HP_U * 20,
    HYDRO_T4_DPS = DEFENSE_DMG_U * 14.5f,

    ROVER_T4_HU = SPECIAL_HP_U * 18,
    ROVER_T4_DPS = SPECIAL_DMG_U * 17.1f,

    //UNITS TIER5
    HELIO_T5_HU = OFFENSE_HP_U * 32f,
    HELIO_T5_DPS = OFFENSE_DMG_U * 24f,

    HYDRO_T5_HU = DEFENSE_HP_U * 35f,
    HYDRO_T5_DPS = DEFENSE_DMG_U * 25.4f,

    ROVER_T5_HU = SPECIAL_HP_U * 34f,
    ROVER_T5_DPS = SPECIAL_DMG_U * 24.3f
    ;
}
