...
public class DrawRingTurret extends DrawBlock {
    ...
    public DrawRingTurret(String basePrefix) {
        this.basePrefix = basePrefix;
    }

    public DrawRingTurret() {
    }
    ...
    public void draw(Building build) {
        PowerRingTurret turret = (PowerRingTurret) build.block;
        PowerRingTurret.PowerRingTurretBuild tb = (PowerRingTurret.PowerRingTurretBuild)build;
    ...
    public void drawTurret(PowerRingTurret block, PowerRingTurret.PowerRingTurretBuild build) {
    ...
    public void drawHeat(PowerRingTurret block, PowerRingTurret.PowerRingTurretBuild build) {
    ...
    public void load(Block block) {
        if (!(block instanceof PowerRingTurret)) {
