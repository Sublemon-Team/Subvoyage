...
public class HydromechWeapon extends Weapon {
    public HydromechWeaponStateStats groundStat, waterStat;
    ...
    protected void handleBullet(Unit unit, WeaponMount mount, Bullet bullet) {
        ...
        HydromechWeaponStateStats stat = getStatState(unit);
    ...
    public HydromechWeaponStateStats getStatState(Unit unit) {
