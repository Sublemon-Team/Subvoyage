...
public class AtlacianPlanetGeneratorOld extends PlanetGenerator {
    ...
    public Color getColor(Vec3 position) {
        ...
        if(biomeMask > 0.4f && patternMask < 0.3f) return sodilateStone.mapColor;
        ...
        pass((x,y) -> {
            ...
            if(secondNoise < sodilateBiomeWeight) {
                if(!floor.asFloor().isLiquid) {
                    floor = darkNoise > 0 ? darkSodilateFloor : sodilateStone;
                }
                else {
